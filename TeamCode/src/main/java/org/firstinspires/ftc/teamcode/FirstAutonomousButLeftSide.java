...
/*
THIS IS A COPY AND PAST OF "FirstAutonomous" WITH MODIFICATION TO THE RUNNING BLOCKS IN THE WHILE SECTION
THE CORRECT THING TO DO WOULD BE TO CREATE INSTRUCTIONS FOR A LEFT AND RIGHT SIDE IN ONE FILE,
AND THEN SWITCH BETWEEN THOSE INSTRUCTIONS IN A SEPERATE EXECUTION FILE.
THE REASON THIS IS NOT HAPENING IS BECAUSE BOTH OF THESE FILES WILL BE SCRAPPED ANYWAYS ONCE WE GET OUR
GRUBBY LITTLE HANDS ONTO SOME ODOMETERS AND INSTALL PEDROPATHING ONTO THE BOT.
 */
...
public class FirstAutonomousButLeftSide extends LinearOpMode {
